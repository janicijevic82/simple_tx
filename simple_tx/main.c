...
int main(void)
{
    ...
    powerValue = dwt_read32bitreg(TX_POWER_ID);
    pokusaj.power=0xc0c0c0c0;
    dwt_configuretxrf(&pokusaj);
    ...
    while(1)
    {
        ...
        writetoLCD( 1, 0,  0x2);
        powerValue2 = dwt_read32bitreg(TX_POWER_ID);
    	sprintf((char*)&dataseq[0], "DecaRanging  %02u", transmitted);
